...
export function PricingCards({ userId, subscriptionPlan }: PricingCardsProps) {
  ...
  return (
    <MaxWidthWrapper>
      <section className="flex flex-col items-center gap-6 py-8 md:py-12 lg:py-16">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center text-center">
          <HeaderSection title="Pricing" />

          <div className="mb-4 mt-10 flex items-center gap-5">
            <ToggleGroup
              type="single"
              size="sm"              defaultValue={isYearly ? "yearly" : "monthly"}
        ...
        <div className="mx-auto grid w-full max-w-5xl gap-5 py-5 md:grid-cols-2 md:px-32">
